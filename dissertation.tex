...
\begin{figure}[!ht]
\centering
\subfloat[Numbers of Studies]{
    \includegraphics[scale=0.7]{MURA-Breakdowns/StudiesByPart.PNG}
    \label{fig:StudiesByPart}
}
\subfloat[Percentage Normal/Abnormal]{
    \includegraphics[scale=0.7]{MURA-Breakdowns/StudiesByPart_Percentages.PNG}
    \label{fig:StudiesByPart_Percentages}
}
...
\begin{figure}[!ht]
\centering
\subfloat[Numbers of Images]{
    \includegraphics[scale=0.7]{MURA-Breakdowns/ImagesByPart.PNG}
    \label{fig:ImagesByPart}
}
\subfloat[Percentage Normal/Abnormal]{
    \includegraphics[scale=0.7]{MURA-Breakdowns/ImagesByPart_Percentages.PNG}
    \label{fig:ImagesByPart_Percentages}
}
\newline
\subfloat[Average Number of Images Per Study]{
    \includegraphics[scale=0.7]{MURA-Breakdowns/ImagesPerStudy.PNG}
    \label{fig:ImagesPerStudy}
}
...
\begin{figure}[!ht]
\centering
\subfloat[Co-occurence by numbers of patients]{
    \includegraphics[scale=0.7]{MURA-Breakdowns/PartCoOccurence.PNG}
    \label{fig:PartCoOccurence}
}
\newline
\subfloat[Percentage Co-occurence]{
    \includegraphics[scale=0.7]{MURA-Breakdowns/PartCoOccurence_Percentages.PNG}
    \label{fig:PartCoOccurence_Percentages}
}
...
\centering
\subfloat{
    \includegraphics[scale=0.7]{MURA-Breakdowns/StudyOutcomesByRole.PNG}
    \label{fig:StudyOutcomesByRole}
}
...
\begin{figure}[!ht]
\centering
\subfloat[Shallower Baseline]{
\includegraphics[scale=0.7]{SimpleBaselineModel_Shallower.PNG}
\label{fig:SimpleBaselineModel_Shallower}}
\subfloat[Deeper Baseline]{
\includegraphics[scale=0.7]{SimpleBaselineModel_Deeper.PNG}
\label{fig:SimpleBaselineModel_Deeper}}
...
\begin{figure}[!ht]
\centering
\subfloat[Accuracy - Training and Validation Sets]{
\includegraphics[scale=0.6]{Results/SimpleBaseline-Small-is-48-48/acc_vanilla.PNG}
\label{fig:acc_vanilla}}
\newline
\subfloat[Loss - Training and Validation Sets]{
\includegraphics[scale=0.6]{Results/SimpleBaseline-Small-is-48-48/loss_vanilla.PNG}
\label{fig:loss_vanilla}}
...
\centering
\subfloat[ROC Curve]{
\includegraphics[scale=0.6]{Results/SimpleBaseline-Small-is-48-48/roc_curve_vanilla.PNG}
\label{fig:roc_curve_vanilla}}
\subfloat[Performance by Site]{
\includegraphics[scale=0.6]{Results/SimpleBaseline-Small-is-48-48/kappa_by_site_vanilla.PNG}
\label{fig:kappa_by_site_vanilla}}
...
\centering
\subfloat[Accuracy - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Small-is-48-48/acc_BN.PNG}
\label{fig:acc_vanilla_BN}}
\newline
\subfloat[Loss - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Small-is-48-48/loss_BN.PNG}
\label{fig:loss_vanilla_BN}}
...
\centering
\subfloat[Accuracy - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Small-is-48-48/acc_dropout.PNG}
\label{fig:acc_vanilla_dropout}}
\newline
\subfloat[Loss - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Small-is-48-48/loss_dropout.PNG}
\label{fig:loss_vanilla_dropout}}
...
\centering
\subfloat[Accuracy - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Small-is-48-48/acc_learnrate_plateau.PNG}
\label{fig:acc_learnrate_plateau}}
\newline
\subfloat[Loss - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Small-is-48-48/loss_learnrate_plateau.PNG}
\label{fig:loss_learnrate_plateau}}
...
\centering
\subfloat[Accuracy - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Small-is-48-48/loss_weight_initialisation.PNG}
\label{fig:acc_weight_initialisation}}
\newline
\subfloat[Loss - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Small-is-48-48/loss_weight_initialisation.PNG}
\label{fig:loss_weight_initialisation}}
...
\centering
\subfloat[Accuracy - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Small-is-48-48/acc_vanilla_rerun.PNG}
\label{fig:acc_vanilla_rerun}}
\newline
\subfloat[Loss - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Small-is-48-48/loss_vanilla_rerun.PNG}
\label{fig:loss_vanilla_rerun}}
...
\centering
\subfloat[Accuracy - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Medium-is-48-48/acc.PNG}
\label{fig:acc_vanilla_medium}}
\newline
\subfloat[Loss - Training and Validation Sets]{
\includegraphics[scale=0.5]{Results/SimpleBaseline-Medium-is-48-48/loss.PNG}
\label{fig:loss_vanilla_medium}}
...
\centering
\subfloat[Accuracy - Training and Validation Sets]{
\includegraphics[scale=0.4]{Results/SimpleBaseline-Small-is-48-48/acc_alt_structures.PNG}
\label{fig:acc_alt_structures}}
\newline
\subfloat[Loss - Training and Validation Sets]{
\includegraphics[scale=0.4]{Results/SimpleBaseline-Small-is-48-48/loss_alt_structures.PNG}
\label{fig:loss_alt_structures}}
...
\centering
\subfloat[Accuracy - Training and Validation Sets]{
\includegraphics[scale=0.6]{Results/VGG16/acc.PNG}
\label{fig:acc_VGG16}}
\newline
\subfloat[Loss - Training and Validation Sets]{
\includegraphics[scale=0.6]{Results/VGG16/loss.PNG}
\label{fig:loss_VGG16}}
\caption{VGG16}
...
\centering
\subfloat[Accuracy - Training and Validation Sets]{
\includegraphics[scale=0.6]{Results/Inception-ResNet-v2/acc.PNG}
\label{fig:acc_IRVN2}}
\newline
\subfloat[Loss - Training and Validation Sets]{
\includegraphics[scale=0.6]{Results/Inception-ResNet-v2/loss.PNG}
\label{fig:loss_IRVN2}}
...
\centering
\subfloat{
\includegraphics[scale=0.5]{XR_ELBOW/Negative/patient05926/study1_negative/image1.png}
\label{fig:Elbow_1}}
\subfloat{
\includegraphics[scale=0.5]{XR_ELBOW/Negative/patient05926/study1_negative/image2.png}
\label{fig:Elbow_2}}
\caption{Patient 05926; Study 1; Elbow; Normal}
\label{fig:MURA_Example_Elbow}
\end{figure}
\FloatBarrier
...
\centering
\subfloat{
\includegraphics[scale=0.5]{XR_FINGER/Positive/patient00234/study1_positive/image1.png}
\label{fig:Finger_1}}
\subfloat{
\includegraphics[scale=0.5]{XR_FINGER/Positive/patient00234/study1_positive/image2.png}
\label{fig:Finger_2}}
\subfloat{
\includegraphics[scale=0.5]{XR_FINGER/Positive/patient00234/study1_positive/image3.png}
\label{fig:Finger_3}}
\caption{Patient 00234; Study 1; Finger; Abnormal}
\label{fig:MURA_Example_Finger}
\end{figure}
\FloatBarrier
...
\centering
\subfloat{
\includegraphics[scale=0.4]{XR_HAND/Positive/patient09836/study1_positive/image1.png}
\label{fig:Hand_1}}
\subfloat{
\includegraphics[scale=0.4]{XR_HAND/Positive/patient09836/study1_positive/image2.png}
\label{fig:Hand_2}}
\newline
\subfloat{
\includegraphics[scale=0.4]{XR_HAND/Positive/patient09836/study1_positive/image3.png}
\label{fig:Hand_3}}
\caption{Patient 09836; Study 1; Hand; Abnormal}
\label{fig:MURA_Example_Hand}
\end{figure}
\FloatBarrier
...
\centering
\subfloat{
\includegraphics[scale=0.5]{XR_HUMERUS/Negative/patient11225/study1_negative/image1.png}
\label{fig:Humerus_1}}
\subfloat{
\includegraphics[scale=0.5]{XR_HUMERUS/Negative/patient11225/study1_negative/image2.png}
\label{fig:Humerus_2}}
\caption{Patient 11225; Study 1; Humerus; Normal}
\label{fig:MURA_Example_Humerus}
\end{figure}
\FloatBarrier
...
\centering
\subfloat{
\includegraphics[scale=0.5]{XR_FOREARM/Positive/patient11417/study1_positive/image1.png}
\label{fig:Forearm_1}}
\newline
\subfloat{
\includegraphics[scale=0.5]{XR_FOREARM/Positive/patient11417/study1_positive/image2.png}
\label{fig:Forearm_2}}
\newline
\subfloat{
\includegraphics[scale=0.4]{XR_FOREARM/Positive/patient11417/study1_positive/image3.png}
\label{fig:Forearm_3}}
\subfloat{
\includegraphics[scale=0.4]{XR_FOREARM/Positive/patient11417/study1_positive/image4.png}
\label{fig:Forearm_4}}
\caption{Patient 11417; Study 1; Forearm; Abnormal}
\label{fig:MURA_Example_Forearm}
\end{figure}
\FloatBarrier
...
\centering
\subfloat{
\includegraphics[scale=0.5]{XR_SHOULDER/Positive/patient00001/study1_positive/image1.png}
\label{fig:Shoulder_1}}
\subfloat{
\includegraphics[scale=0.5]{XR_SHOULDER/Positive/patient00001/study1_positive/image2.png}
\label{fig:Shoulder_2}}
\newline
\subfloat{
\includegraphics[scale=0.5]{XR_SHOULDER/Positive/patient00001/study1_positive/image3.png}
\label{fig:Shoulder_3}}
\caption{Patient 00001; Study 1; Shoulder; Abnormal}
\label{fig:MURA_Example_Shoulder}
\end{figure}
\FloatBarrier
...
\centering
\subfloat{
\includegraphics[scale=0.4]{XR_WRIST/Positive/patient01521/study1_positive/image1.png}
\label{fig:Wrist_1}}
\subfloat{
\includegraphics[scale=0.4]{XR_WRIST/Positive/patient01521/study1_positive/image2.png}
\label{fig:Wrist_2}}
\newline
\subfloat{
\includegraphics[scale=0.4]{XR_WRIST/Positive/patient01521/study1_positive/image3.png}
\label{fig:Wrist_3}}
\subfloat{
\includegraphics[scale=0.4]{XR_WRIST/Positive/patient01521/study1_positive/image4.png}
\label{fig:Wrist_4}}
\caption{Patient 01521; Study 1; Wrist; Abnormal}
\label{fig:MURA_Example_Wrist}
\end{figure}
\FloatBarrier
