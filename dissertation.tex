...
\\
\noindent
AlexNet in 2012 was the first winner to use a Deep Learning with convolutional neural networks, and as can be seen achieved a considerable improvement in performance over the previous year's winner. Since then, all winners have used variations or extensions of the Deep Learning/convolutional network idea. Below we describe some of these winning networks in more detail.
\\
\\
\noindent
\subsubsection{VGG}
