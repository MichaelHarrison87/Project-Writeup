...
\end{cases}\]
That is, accuracy simply meansures the proportion of correct predictions the network makes on a dataset.

\subsubsection{Confusion Matrix}
The confusion matrix decomposes the correct and incorrect predictions for each class. For instance, if there are two classes \(0\) and \(1\),  
